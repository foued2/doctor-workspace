...
- `checker_rejected_samples` — checker failed on its own sample cases
- `checker_rejected_invariants` — checker accepted a known violation
- `checker_rejected_negatives` — checker accepted a wrong output
...
WARNING: This verdict is not authoritative. 
