...
PERTURBATION_PACK = [
    ...
    ("SIMILAR_MAX_SUM_VS_PRODUCT_OBJ", None, "objective_swap", "Find the contiguous subarray with the maximum product. (vs maximum SUM would be different)"),
    ...
    ("SIMILAR_CLIMBING_WAYS_VS_COST_OBJ", None, "objective_swap", "Find the minimum cost to reach the top. (vs number of ways would be different)"),
    ("SIMILAR_LIS_VS_LCS_OBJ", None, "objective_swap", "Find the longest common subsequence between two arrays. (vs longest increasing - similar structure, different problem)"),
...
EXPECTED = {
    ...
    "SIMILAR_MAX_SUM_VS_PRODUCT_OBJ": (None, "reject"),
    "SIMILAR_TWO_SUM_VS_THREE_SUM_OBJ": ("three_sum", "match"),
    "SIMILAR_CLIMBING_WAYS_VS_COST_OBJ": (None, "reject"),
    "SIMILAR_LIS_VS_LCS_OBJ": (None, "reject"),
